...
<h1>VENDER</h1>
    ...
    <form action="vender.php" class="form-container" method="POST">
        ...
        <fieldset>
            ...
            <div><label>Nombre:</label> <input type="text" name="productName"  /></div>
            <div><label>Precio:</label> <input type="text" name="productPrice"  /></div>
            <div><label>Descripcion:</label> <input type="text" name="productDescr"  /></div>
            <div><label>Tipo:</label> <input type="text" name="productType"  /></div>
            <div><label>Fecha:</label> <input type="date" name="productDate"  /></div>
            <div><label>Cantidad:</label> <input type="text" name="amount"  /></div>
