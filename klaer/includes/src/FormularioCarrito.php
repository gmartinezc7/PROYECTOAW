...
class FormularioCarrito extends Formulario
{
    public function __construct() {
        parent::__construct('formCarrito', ['urlRedireccion' => Aplicacion::getInstance()->resuelve('/index.php')]);
    }
    ...
    protected function generaCamposFormulario(&$datos)
    {
		...
		$productDescr = $datos['descripcion'] ?? '';
        $productType = $datos['tipo'] ?? '';
		$productDate = $datos['telefono'] ?? '';
        $productCant = $datos['email'] ?? '';
